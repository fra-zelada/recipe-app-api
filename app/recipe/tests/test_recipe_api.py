...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_tag_on_update(self):
        """test create tag on update a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_ingredient_on_update_recipe(self):
        """test create ingredient on update recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_asssign_ingredient(self):
        """test update recipe asssign ingredient"""
    ...
    def test_clear_recipe_ingredeients(self):
        """test clear recipe ingredeients"""
